...
interface BGGApiService {
    @GET("collection")
    suspend fun getCollection(@Query("username") username: String): CollectionItems // Need to handle the 202 or whatever response for when the stuff isn't ready yet
